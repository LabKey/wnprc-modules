...
select setname, container, 'x' as value, 'special housing condition' as title, 'special' as category, 'any' as description from ehr_lookups.lookup_sets where setname='housing_condition_codes';

insert into ehr_lookups.lookups (set_name,container,value,title,category,description)
select setname, container, 'c' as value, 'chair' as title, 'pairing' as category, 'any' as description from ehr_lookups.lookup_sets where setname='housing_condition_codes';

insert into ehr_lookups.lookups (set_name,container,value,title,category,description)
select setname, container, 's' as value, 'single' as title, 'pairing' as category, 'any' as description from ehr_lookups.lookup_sets where setname='housing_condition_codes';

insert into ehr_lookups.lookups (set_name,container,value,title,category,description)
select setname, container, 'p' as value, 'paired' as title, 'pairing' as category, 'any' as description from ehr_lookups.lookup_sets where setname='housing_condition_codes';

insert into ehr_lookups.lookups (set_name,container,value,title,category,description)
select setname, container, 'g' as value, 'in a group (+3 animals living together)' as title, 'pairing' as category, 'any' as description from ehr_lookups.lookup_sets where setname='housing_condition_codes';
*/
/*insert into ehr_lookups.lookups (set_name,container,value,title,category,description)
select setname, container, 'pc' as value, 'protected contact' as title, 'caging' as category, 'any' as description from ehr_lookups.lookup_sets where setname='housing_condition_codes';
*/
/*insert into ehr_lookups.lookups (set_name,container,value,title,category,description)
select setname, container, 'vc' as value, 'visual contact' as title, 'caging' as category, 'any' as description from ehr_lookups.lookup_sets where setname='housing_condition_codes';
*/

/*insert into ehr_lookups.lookups (set_name,container,value,title,category,description)
select setname, container, 'b' as value, 'breeding' as title, 'social' as category, 'adult' as description from ehr_lookups.lookup_sets where setname='housing_condition_codes';
*/
...
/*insert into ehr_lookups.lookups (set_name,container,value,title,category,description)
select setname, container, 'm' as value, 'infant with the mother/dam' as title, 'social' as category, 'infant' as description from ehr_lookups.lookup_sets where setname='housing_condition_codes';

insert into ehr_lookups.lookups (set_name,container,value,title,category,description)
select setname, container, 'f' as value, 'infant with the father/sire' as title, 'social' as category, 'infant' as description from ehr_lookups.lookup_sets where setname='housing_condition_codes';

insert into ehr_lookups.lookups (set_name,container,value,title,category,description)
select setname, container, 'am' as value, 'infant with adopted mother/dam' as title, 'social' as category, 'infant' as description from ehr_lookups.lookup_sets where setname='housing_condition_codes';

insert into ehr_lookups.lookups (set_name,container,value,title,category,description)
select setname, container, 'af' as value, 'infant with adopted father/sire' as title, 'social' as category, 'infant' as description from ehr_lookups.lookup_sets where setname='housing_condition_codes';
*/
