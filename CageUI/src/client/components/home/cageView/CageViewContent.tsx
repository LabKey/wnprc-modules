...
import { CageDimensions, ModLocations } from '../../../types/typings';
...
export const CageViewContent: FC = () => {
    ...
    return (
        selectedCage &&
        <div className={"room-view-container"} key={'layout-' + selectedRoom + '-rack-' + selectedRack.itemId + '-' + selectedCage.cageNum}>
