...
public class AllHistoryTable extends SimpleUserSchema.SimpleTable<CageUIUserSchema>
{
    public AllHistoryTable(CageUIUserSchema schema, TableInfo table, ContainerFilter cf)
    {
    ...
    {
        return new AllHistoryTable.UpdateService(this);
    }
    ...
    protected class UpdateService extends SimpleQueryUpdateService
    {
        ...
        public boolean hasPermission(@NotNull UserPrincipal user, Class<? extends Permission> perm)
        {
            ...
            if (isEditPerm)
            {
                return super.hasPermission(user, CageUILayoutEditorAccessPermission.class) || super.hasPermission(user, CageUIModificationEditorPermission.class) || super.hasPermission(user, CageUIAnimalEditorPermission.class);
            }
        ...
        public List<Map<String, Object>> insertRows(User user, Container container, List<Map<String, Object>> rows, BatchValidationException errors, @Nullable Map<Enum, Object> configParameters, @Nullable Map<String, Object> extraScriptContext) throws DuplicateKeyException, QueryUpdateServiceException, SQLException
        {
            ...
            if (super.hasPermission(user, CageUILayoutEditorAccessPermission.class) || super.hasPermission(user, CageUIModificationEditorPermission.class) || super.hasPermission(user, CageUIAnimalEditorPermission.class))
            {
