...
public class CageHistoryTable extends SimpleUserSchema.SimpleTable<CageUIUserSchema>
{
    public CageHistoryTable(CageUIUserSchema schema, TableInfo table, ContainerFilter cf)
    {
    ...
    {
        return new CageHistoryTable.UpdateService(this);
    }
