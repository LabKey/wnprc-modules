...
public class CageModificationsHistoryTable extends SimpleUserSchema.SimpleTable<CageUIUserSchema>
{
    public CageModificationsHistoryTable(CageUIUserSchema schema, TableInfo table, ContainerFilter cf)
    {
    ...
    {
        return new CageModificationsHistoryTable.UpdateService(this);
    }
