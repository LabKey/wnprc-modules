...
public class CageModificationsTable extends SimpleUserSchema.SimpleTable<CageUIUserSchema>
{
    public CageModificationsTable(CageUIUserSchema schema, TableInfo table, ContainerFilter cf)
    {
    ...
    {
        return new CageModificationsTable.UpdateService(this);
    }
