...
public class CagesTable extends SimpleUserSchema.SimpleTable<CageUIUserSchema>
{
    public CagesTable(CageUIUserSchema schema, TableInfo table, ContainerFilter cf)
    {
    ...
    {
        return new CagesTable.UpdateService(this);
    }
