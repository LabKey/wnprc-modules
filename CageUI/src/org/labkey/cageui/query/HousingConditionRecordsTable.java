...
public class HousingConditionRecordsTable extends SimpleUserSchema.SimpleTable<CageUIUserSchema>
{
    public HousingConditionRecordsTable(CageUIUserSchema schema, TableInfo table, ContainerFilter cf)
    {
    ...
    {
        return new HousingConditionRecordsTable.UpdateService(this);
    }
