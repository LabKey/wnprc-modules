...
public class RoomHistoryTable extends SimpleUserSchema.SimpleTable<CageUIUserSchema>
{
    public RoomHistoryTable(CageUIUserSchema schema, TableInfo table, ContainerFilter cf)
    {
    ...
    {
        return new RoomHistoryTable.UpdateService(this);
    }
