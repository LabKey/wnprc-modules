...
public class WNPRC_EHRController extends SpringActionController
{
    ...
    public class GetChangeLists extends ApiAction<NullFORM> {
        public ApiResponse execute(NullFORM form, BindException errors) throws Exception {
            ...
            for (Resource resource : changelistDir.list()) {
                if (resource.isFile()) { // Don't traverse subdirectories.
    ...
    public static class PopulationEventsOverPeriodForm {
        ...
        public void setStartdate(Date date) { _startdate = date; }
    ...
    public static class VirologyResultsForm extends EmailServerForm {
        ...
        public String getFromList() { return _fromList; }

        public void setSubject(String subject)   { _subject = subject;   }
        public void setDate(String date)         { _date = date;         }
        public void setFromList(String fromList) { _fromList = fromList; }
