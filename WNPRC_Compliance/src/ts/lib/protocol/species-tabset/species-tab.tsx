...
import {SpeciesForm} from "../../../../../build/generated-ts/GeneratedFromJava";
...
export class ProtocolSpeciesTab extends React.Component<ProtocolSpeciesTabProps, ProtocolSpeciesTabState> {
    ...
    handleChange(e: ChangeEvent<HTMLInputElement>) {
        this.props.info.maxNumberOfAnimals = parseInt(e.target.value);
        this.forceUpdate();
    }
                ...
                <div className="row">
                    <div className="form-group">
                        ...
                        <div className="col-sm-9">
                            <input value={this.state.info.maxNumberOfAnimals} className="form-control" type="number" min="0" onChange={this.handleChange} />
                        </div>
                    </div>
                </div>
