...
function onAfterInsert(helper,errors,row){
    ...
    var threadId = WNPRC.Utils.getJavaHelper().setUpMessageBoardThread(row, "/WNPRC/WNPRC_Units/Animal_Services/SPI/Private/");
    WNPRC.Utils.getJavaHelper().updateRow(row, threadId, "wnprc", "animal_requests", "internalthreadrowid");
    var threadIdExternal = WNPRC.Utils.getJavaHelper().setUpMessageBoardThread(row, "/WNPRC/WNPRC_Units/Animal_Services/SPI/Restricted/");
