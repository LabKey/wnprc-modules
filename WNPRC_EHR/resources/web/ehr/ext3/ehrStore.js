        ...
        if (this.queryName == 'Housing'){
            ...
            for (var idx = 0; idx < allRecords.length; ++idx){
                ...
                map[id].push({
                    ...
                    reason: record.fields.get('reason') ? record.get('reason') : null,
                    remark: record.fields.get('remark') ? record.get('remark') : null,
                    project: record.fields.get('project') ? record.get('project') : null,
                    performedby: record.fields.get('performedby') ? record.get('performedby') : null,
                    ejacConfirmed: record.fields.get('ejacConfirmed') ? record.get('ejacConfirmed') : null,
                    event: record.phantom ? 'insert' : 'update'
                });
            }
