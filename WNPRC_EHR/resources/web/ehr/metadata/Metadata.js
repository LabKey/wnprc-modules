...
EHR.Metadata.Columns = {
    ...
    Assignment:                      EHR.Metadata.topCols + ',projectedRelease,animal_request_rowid,'                                                                                                                                                                                                              + EHR.Metadata.bottomCols,
    ...
    blood:                          'id/curlocation/location,'+ 'id,date,performedby,enddate,project,account' + ',objectid,requestid,tube_type,tube_vol,num_tubes,quantity,requestor,additionalServices,billedby,assayCode,restraint,restraintDuration,daterequested,instructions,'                                                     +'remark,qcstate,'+EHR.Metadata.hiddenCols,
    ...
    'Housing':                       'id,project,date,enddate,room,cage,cageNew,id/numroommates/cagemates,cond,condNew,reason,isTemp,'                                                                                                                                                                        + EHR.Metadata.bottomCols,
