...
EHR.Metadata.Columns = {
    ...
    Arrival:                         EHR.Metadata.topCols + ',source,vendor_id,geographic_origin,ancestry,gender,birth,dam,sire,initialRoom,initialCage,initialCond,id/numroommates/cagemates,'                                                                                                                  + EHR.Metadata.bottomCols,
    Assignment:                      EHR.Metadata.topCols + ',projectedRelease,'                                                                                                                                                                                                              + EHR.Metadata.bottomCols,
    'Bacteriology Results':          EHR.Metadata.topCols + ',method,organism,source,qualresult,result,units,antibiotic,sensitivity,performing_lab,'                                                                                                                                          + EHR.Metadata.bottomCols,
    'Behavior Remarks':              EHR.Metadata.topCols + ',so,a,p,category,'                                                                                                                                                                                                               + EHR.Metadata.bottomCols,
    Biopsies:                        EHR.Metadata.topCols + ',billingComplete,caseno,type,veterinarian,performedby,nhpbmd,grossdescription,histologicalDescription,'                                                                                                                          + EHR.Metadata.bottomCols + ',patho_notes',
    Birth:                           EHR.Metadata.topCols + ',estimated,gender,weight,wdate,dam,sire,room,cage,cond,origin,ancestry,conception,type,'                                                                                                                                                  + EHR.Metadata.bottomCols,
    blood:                          'id/curlocation/location,' + EHR.Metadata.topCols + ',objectid,requestid,tube_type,tube_vol,num_tubes,quantity,requestor,additionalServices,billedby,assayCode,restraint,restraintDuration,daterequested,instructions,'                                                     + EHR.Metadata.bottomCols,
    ...
    'Chemistry Results':             EHR.Metadata.topCols + ',testid,method,resultOORIndicator,result,units,qualResult,performing_lab,'                                                                                                                                                       + EHR.Metadata.bottomCols,
    ...
    'Clinpath Runs':                 EHR.Metadata.topCols + ',servicerequested,type,sampletype,sampleId,collectionMethod,collectedBy,performing_lab,'                                                                                                                                         + EHR.Metadata.bottomCols,
    'Cytology Automated Evaluation': EHR.Metadata.topCols + ',sampleType,collectionMethod,testid,result,units,performing_lab,'                                                                                                                                                                + EHR.Metadata.bottomCols,
    'Cytology Manual Evaluation':    EHR.Metadata.topCols + ',sampleType,collectionMethod,sampleAppearance,slidesMade,slidesSubmitted,stainType,results,reviewedBy,performing_lab,'                                                                                                           + EHR.Metadata.bottomCols,
    ...
    'Drug Administration':           'id/curlocation/location,' + 'id,date,begindate,enddate,project,account' + ',code,qualifier,category,route,dosage,dosage_units,volume,vol_units,amount,amount_units,concentration,conc_units,headerdate,restraint,restraintDuration,remark,performedby,' + EHR.Metadata.bottomCols,
    ...
    'Hematology Results':            EHR.Metadata.topCols + ',testid,method,result,units,qualResult,performing_lab,'                                                                                                                                                                          + EHR.Metadata.bottomCols,
    'Hematology Morphology':         EHR.Metadata.topCols + ',morphology,score,performing_lab,'                                                                                                                                                                                               + EHR.Metadata.bottomCols,
    ...
    'Immunology Results':            EHR.Metadata.topCols + ',testid,method,result,units,qualResult,performing_lab,'                                                                                                                                                                          + EHR.Metadata.bottomCols,
    ...
    'Parasitology Results':          EHR.Metadata.topCols + ',organism,method,result,units,qualresult,performing_lab,'                                                                                                                                                                        + EHR.Metadata.bottomCols,
    ...
    requests:                        'rowid,requestid,title,formtype,daterequested,priority,notify1,notify2,notify3,createdby,qcstate'                                                                                                                                                                                           ,
    ...
    'Urinalysis Results':            EHR.Metadata.topCols + ',testid,method,resultOORIndicator,result,units,qualResult,performing_lab,'                                                                                                                                                       + EHR.Metadata.bottomCols,
    'Virology Results':              EHR.Metadata.topCols + ',virus,method,source,resultOORIndicator,result,units,qualResult,performing_lab,'                                                                                                                                                 + EHR.Metadata.bottomCols,
