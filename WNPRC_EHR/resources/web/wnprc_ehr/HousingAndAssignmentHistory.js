(function(){
            ...
            runQueries: function () {
                ...
                jQuery.each(this.queries, function (key, value) {
                    ...
                    config.success = function (data) {
                        self.datasets[key] = new SuperSQLStore.ObservableTable({rows: data.rows});
    ...
    ko.components.register('d3-graph', {
        template: { ajax: '/wnprc_ehr/d3-graph-template.html'},
        viewModel: {
    ...
    ko.components.register("animal-housing", {
        template: { ajax: '/wnprc_ehr/HousingAndAssignmentHistoryTemplate.html'},
        viewModel: {
            createViewModel: function (params, componentInfo) {
