...
//        }
    ...
    public void sendViralLoadQueueNotification(String[] keys, Integer status, String hostName) throws SQLException
    {
        Module ehr = ModuleLoader.getInstance().getModule("EHR");
        ...
        if ("08-complete-email-Zika_portal".equals(recordStatus)){
            ...
            ViralLoadQueueNotification notification = new ViralLoadQueueNotification(ehr, keys, user, viralLoadContainer, hostName);
            Container ehrContainer =  ContainerManager.getForPath("/WNPRC/EHR");
            notification.sendManually(ehrContainer,user);
        }
    }
