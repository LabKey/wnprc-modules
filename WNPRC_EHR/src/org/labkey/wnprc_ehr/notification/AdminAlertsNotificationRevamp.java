...
//        Date dateSevenDaysAgo = dateToolkit.getDateXDaysFromNow(-7);
            ...
            // Runs query.
            ArrayList<HashMap<String, String>> returnArray = notificationToolkit.getTableMultiRowMultiColumnWithFieldKeys(currentContainer, currentUser, "core", "SiteUsageByDay", myFilter, null, targetColumns);
