...
public class BloodAlertsNotificationRevampResearchStaff extends AbstractEHRNotification {
    //Class Variables
     ...
     * @param owner
     */
    public BloodAlertsNotificationRevampResearchStaff(Module owner) {super(owner);}
    ...
    {
        return "Blood Alerts Revamp (Research Staff)";
    }
    @Override
    ...
    public String getMessageBodyHTML(Container c, User u) {
        ...
        String testString = bloodAlertShared.getBloodDrawNotificationMessageBody(c, u, "Research Staff", "full");
        return testString;
    }
}
