...
public class BloodAlertsNotificationRevampSPI extends AbstractEHRNotification {
    //Class Variables
     ...
     * @param owner
     */
    public BloodAlertsNotificationRevampSPI(Module owner) {super(owner);}
    ...
    {
        return "Blood Alerts Revamp (SPI)";
    }
    @Override
    ...
    public String getMessageBodyHTML(Container c, User u) {
        ...
        String testString = bloodAlertShared.getBloodDrawNotificationMessageBody(c, u, "SPI", "full");
        return testString;
    }
}
