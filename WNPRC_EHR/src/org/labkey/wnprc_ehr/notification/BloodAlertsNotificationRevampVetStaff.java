...
public class BloodAlertsNotificationRevampVetStaff extends AbstractEHRNotification {
    //Class Variables
     ...
     * @param owner
     */
    public BloodAlertsNotificationRevampVetStaff(Module owner) {super(owner);}
    ...
    {
        return "Blood Alerts Revamp (Vet Staff)";
    }
    @Override
    ...
    public String getMessageBodyHTML(Container c, User u) {
        ...
        String testString = bloodAlertShared.getBloodDrawNotificationMessageBody(c, u, "Vet Staff", "full");
        return testString;
    }
}
