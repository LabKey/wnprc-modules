...
<%--                    &lt;%&ndash;<!-- ko if: !_.isBlank(cur_room()) && !_.isBlank(cur_cage()) -->&ndash;%&gt;--%>
...
<%--                </dl>--%>
<%--                &lt;%&ndash;<!-- /ko -->&ndash;%&gt;--%>
<%--                &lt;%&ndash;<!-- ko if: hold() -->&ndash;%&gt;--%>
<%--                    <div style="text-align: right;">--%>
<%--                        <button class="btn btn-danger" data-bind="click: $root.cancelHeldEvent">Cancel</button>--%>
<%--                    </div>--%>
<%--                &lt;%&ndash;<a class="btn btn-default" href="{{$parent.cancelHeldEvent}}"         data-bind="css: { disabled: _.isBlank(taskid()) }">Cancel</a>&ndash;%&gt;--%>
<%--                &lt;%&ndash;<!-- /ko -->&ndash;%&gt;--%>
<%--                &lt;%&ndash;<a class="btn btn-default" href="{{$parent.viewNecropsyReportURL}}" data-bind="css: { disabled: _.isBlank(taskid()) }">Report</a>&ndash;%&gt;--%>
<%--                &lt;%&ndash;<a class="btn btn-default" href="{{$parent.viewNecropsyURL}}"       data-bind="css: { disabled: _.isBlank(taskid()) }">View Record</a>&ndash;%&gt;--%>
<%--                &lt;%&ndash;<a class="btn btn-primary" href="{{$parent.editNecropsyURL}}"       data-bind="css: { disabled: _.isBlank(taskid()) }">Edit Record</a>&ndash;%&gt;--%>
<%--            </div>--%>
<%--        </div>--%>
<%--    </div>--%>
...
<%--                        &lt;%&ndash;<label class="col-xs-4 control-label">Pathologist</label>&ndash;%&gt;--%>
<%--                        &lt;%&ndash;<div class="col-xs-8">&ndash;%&gt;--%>
<%--                            &lt;%&ndash;&lt;%&ndash;<select data-bind="value: pathologist" class="form-control">&ndash;%&gt;&ndash;%&gt;--%>
<%--                                &lt;%&ndash;&lt;%&ndash;<option value=""></option>&ndash;%&gt;&ndash;%&gt;--%>
<%--                                &lt;%&ndash;&lt;%&ndash;&lt;%&ndash;%>&ndash;%&gt;--%>
<%--                                    &lt;%&ndash;&lt;%&ndash;for(JSONObject pathologist : pathologistList) {&ndash;%&gt;&ndash;%&gt;--%>
<%--                                        &lt;%&ndash;&lt;%&ndash;String userid = pathologist.getString("userid");&ndash;%&gt;&ndash;%&gt;--%>
<%--                                        &lt;%&ndash;&lt;%&ndash;String internaluserid = pathologist.getString("internaluserid");&ndash;%&gt;&ndash;%&gt;--%>
<%--                                &lt;%&ndash;&lt;%&ndash;%>&ndash;%&gt;&ndash;%&gt;--%>
<%--                                &lt;%&ndash;&lt;%&ndash;<option value="<%=internaluserid%>"><%=h(userid)%></option>&ndash;%&gt;&ndash;%&gt;--%>
<%--                                &lt;%&ndash;&lt;%&ndash;&lt;%&ndash;%>&ndash;%&gt;--%>
<%--                                    &lt;%&ndash;&lt;%&ndash;}&ndash;%&gt;&ndash;%&gt;--%>
<%--                                &lt;%&ndash;&lt;%&ndash;%>&ndash;%&gt;&ndash;%&gt;--%>
...
<%--                    &lt;%&ndash;<div class="form-group">&ndash;%&gt;--%>
<%--                        &lt;%&ndash;<label class="col-xs-4 control-label">Prosector</label>&ndash;%&gt;--%>
<%--                        &lt;%&ndash;<div class="col-xs-8">&ndash;%&gt;--%>
<%--                            &lt;%&ndash;&lt;%&ndash;<select data-bind="value: assistant" class="form-control">&ndash;%&gt;&ndash;%&gt;--%>
<%--                                &lt;%&ndash;&lt;%&ndash;<option value=""></option>&ndash;%&gt;&ndash;%&gt;--%>
<%--                                &lt;%&ndash;&lt;%&ndash;&lt;%&ndash;%>&ndash;%&gt;--%>
<%--                                    &lt;%&ndash;&lt;%&ndash;for(JSONObject pathologist : pathologistList) {&ndash;%&gt;&ndash;%&gt;--%>
<%--                                        &lt;%&ndash;&lt;%&ndash;String userid = pathologist.getString("userid");&ndash;%&gt;&ndash;%&gt;--%>
...
<%--                        &lt;%&ndash;<div class="col-xs-8">&ndash;%&gt;--%>
<%--                            &lt;%&ndash;<p class="form-control">{{statuschangereason}}</p>&ndash;%&gt;--%>
<%--                            &lt;%&ndash;&lt;%&ndash;<input type="hidden" class="hidden-assignedTo-field" data-bind="value: assignedTo">&ndash;%&gt;&ndash;%&gt;--%>
<%--                            &lt;%&ndash;&lt;%&ndash;<input type="text" class="form-control assignedTo-field">&ndash;%&gt;&ndash;%&gt;--%>
<%--                        &lt;%&ndash;</div>&ndash;%&gt;--%>
<%--                    </div>--%>
