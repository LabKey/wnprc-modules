...
public class wnprc_r24Module extends DefaultModule
{
    public static final String NAME = "wnprc_r24";
    ...
    protected void init()
    {
        addController(wnprc_r24Controller.NAME, wnprc_r24Controller.class);
    }
    ...
    public void doStartup(ModuleContext moduleContext)
    {
        ...
        ContainerManager.addContainerListener(new wnprc_r24ContainerListener());
    ...
    {
        return Collections.singleton(wnprc_r24Schema.NAME);
    }
}