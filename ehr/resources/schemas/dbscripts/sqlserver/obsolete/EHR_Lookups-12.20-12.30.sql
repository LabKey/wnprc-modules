...
ALTER TABLE ehr_lookups.snomed_subsets DROP column container;
...
ALTER TABLE ehr_lookups.areas ADD description varchar(500);
...
ALTER table ehr_lookups.source add SourceCity varchar(200);
ALTER table ehr_lookups.source add SourceState varchar(200);
ALTER table ehr_lookups.source add SourceCountry varchar(200);
...
ALTER TABLE ehr_lookups.procedures ADD major bit default 0;
