...
ALTER TABLE ehr_lookups.procedure_default_charges ADD procedureid int;
ALTER TABLE ehr_lookups.procedure_default_treatments ADD procedureid int;

ALTER TABLE ehr_lookups.procedures ADD active bit;
ALTER TABLE ehr_lookups.procedures DROP COLUMN "procedure";
ALTER TABLE ehr_lookups.procedures ADD name varchar(200);
