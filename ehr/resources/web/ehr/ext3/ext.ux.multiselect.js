...
Ext.ux.form.MultiSelect = Ext.extend(Ext.form.Field, {
   ...
   *      is bound (defaults to <tt>undefined</tt>). Acceptable values for
   *      this property are: <div class="mdetail-params">
   *      <ul>
   ...
   *      class="sub-desc"> A 1-dimensional array will automatically be expanded
   ...
   *      index 1 is assumed to be the combo {@link #displayField text}. </div></li>
   *      </ul>
   *      </div></li>
   *      </ul>
   *      </div>
