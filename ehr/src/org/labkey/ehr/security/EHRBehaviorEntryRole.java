 ...
 * Time: 7:42 PM
 */
public class EHRBehaviorEntryRole extends AbstractEHRRole
{
    public EHRBehaviorEntryRole()
    {
        super("EHR Behavior Entry", "This role is used to track which users can enter behavior data.",
