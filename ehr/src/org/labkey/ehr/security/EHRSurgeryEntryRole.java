 ...
 * Time: 7:42 PM
 */
public class EHRSurgeryEntryRole extends AbstractEHRRole
{
    public EHRSurgeryEntryRole()
    {
        super("EHR Surgery Entry", "This role is used to track which users can enter surgeries.",
