...
SELECT
  ...
  bloodSch.billedby.value as billedby
...
GROUP BY bloodSch.date, bloodSch.id, bloodSch.project.account, bloodSch.billedby.value, bloodSch.performedby, bloodSch.billedby.value